...
public class RegisterActivity extends ActionBarActivity {
    ...
    public void setupNavigationDrawer() {
        ...
        RegisterActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue, true);
    ...
    private void setupNavigationDrawerRecyclerViews() {
        ...
        linearLayoutManager2 = new LinearLayoutManager(RegisterActivity.this);
        ...
        linearLayoutManager3 = new LinearLayoutManager(RegisterActivity.this);
        ...
        linearLayoutManagerSettings = new LinearLayoutManager(RegisterActivity.this);
